...
const hero = (
  ...
  >
    <h1 className="font-serif font-light text-white tracking-[0.3em] md:tracking-[0.75em]" style={{ fontSize: "clamp(28px, 10vw, 64px)" }}>
      SHOES
    </h1>
...
export default function BodyShopShoes() {
  ...
  const shoes = products.filter((p) => SHOE_CATS.includes(p.category));
  return <CategoryPage hero={hero} filters={FILTERS} products={shoes} loading={loading} error={error} />;
}
