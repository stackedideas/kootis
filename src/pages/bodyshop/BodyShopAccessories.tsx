...
const hero = (
  ...
  >
    <h1 className="font-serif font-light text-white tracking-[0.2em] md:tracking-[0.5em]" style={{ fontSize: "clamp(22px, 6vw, 56px)" }}>
      ACCESSORIES
    </h1>
...
export default function BodyShopAccessories() {
  ...
  return <CategoryPage hero={hero} filters={FILTERS} products={accessories} loading={loading} error={error} />;
}
